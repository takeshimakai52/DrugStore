<?php
require 'common.php';
$itemid = filter_input(INPUT_POST, 'baikaid');
...
<!-- フォームはここから -->
            <form action="baikaconfirm.php" method="post">
            ...
            <div class="syouhinrow">
              ...
              <div class="rowright">
                <input type="text" name="saleprice"  class="textrightbox" required>
              </div>
            </div>
            <div class="syouhinrow">
              <div class="rowleft">
              ...
              <div class="rowright">
                <input type="date" name="fromdate" class="textrightbox" required>
              </div>
            </div>
            <div class="syouhinrow">
              <div class="rowleft">
              ...
              <div class="rowright">
                <input type="date" name="todate" class="textrightbox"　required>
              </div>
            </div>
